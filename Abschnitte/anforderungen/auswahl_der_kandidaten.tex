...
\begin{enumerate}
	...
	\item intervall-kontingente Erfassung und/oder Erfassung im Nachhinein durch die FKS (explizites Erleben)

	\item kontinierliche Erfassung der Bewegung (impliziter Bewegungsaufwand)

	\item kontinierliche Erfassung der Herzaktivität (implizite HRV)

	\item Kombination von 2. und 3. (implizite kardio-lokomotorische Phasensynchronisation)
...
\begin{figure}[t]
	\centering
		\includegraphics[width=1.00\textwidth]{4_1_datenraum.pdf}
