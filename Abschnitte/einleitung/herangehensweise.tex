...
\begin{enumerate}
	...
	\item Die Daten dienen in akkumulierter Form als implizite Merkmale (Kandidaten), die ich den Komponenten des Flow-Konstrukts zu ordne. Ausgehend von den expliziten Merkmalen (Kreterien) untersuche ich die Korrelation zu diesen Kandidaten für ein implizites Messverfahren (Prädiktoren).
