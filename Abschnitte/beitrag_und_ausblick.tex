...
\begin{itemize}
	...
	\item Ich konnte einen intraindividuellen Zusammenhang zwischen Flow-Erleben und Doppelschrittfrequenz sowie einen interindividuellen Zusammenhang zwischen Flow-Erleben und der kardio-lokomotorischen Phasensynchronisation (Anschnitt~\ref{ssub:die_kardio_lokomotorische_phasensynchronisation}) als eine implizit \emph{physiologisch messbare \ac{AFP}} nachweisen.
\end{itemize}
