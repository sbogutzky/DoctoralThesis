...
Diese Trennung macht für die vorliegende Arbeit Sinn, da ich davon ausgehe, dass man die beiden Kernmerkmale das \emph{gänzliche Aufgehen in der Tätigkeit} und den \emph{glatten Handlungsverlauf} implizit messen kann. Die dargestellten Voraussetzungen sind hingegen herzustellen und ihr Vorhandensein kann ich in der Regel nur explixit nachweisen. 
\begin{table}
