...
\begin{itemize}
	...
	\item einer Anpassung des \acs{VNS}s, die entweder zu einem optimalen Zustand der Erregung \citep{Peifer2014} oder sich in einer Abnahme der mentalen und körperlichen Anstrengung \citep{deManzano2010} ausdrückt,
...
\begin{sidewaysfigure}
	...
	\textwidth]{prozessorientiertes_flow_modell_2.pdf} \caption[Prozessorientiertes Modell des Flow-Erlebens (erweitert).]{Prozessorientiertes Modell mit Annahmen zu implizit messbaren Auswirkungen des Flow-Erlebens.} \label{fig:prozessorientiertes_flow_modell_2} 
\end{sidewaysfigure}
