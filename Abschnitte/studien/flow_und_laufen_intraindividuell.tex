...
\begin{sidewaysfigure}
	...
	%
	\caption[Aufgenommene Datenströme (Erste Studie: Laufen).]{Aufgenommene Datenströme eines Bewegungsaublaufs in der ersten Studie zum Flow-Erleben beim Laufen. Von links nach rechts: (schwarz) \ac{EKG}-Ableitung RA-LL und \ac{EKG}-Ableitung LA-LL; (grün) Beschleunigung in X-Richtung und Winkelgeschwindigkeit um die X Achse; (blau) Beschleunigung in Y-Richtung und Winkelgeschwindigkeit um die Y-Achse; (rot) Beschleunigung in Z-Richtung und Winkelgeschwindigkeit um die Z-Achse.} \label{fig:rohdaten_1} 
\end{sidewaysfigure}
...
\begin{figure}
	[!htb] \input{./tikz/regressionsanalyse_1} \caption[Quadratische Zusammenhänge zwischen expliziten und impliziten Merkmalen (Erste Studie: Laufen).]{Quadratische Zusammenhänge zwischen expliziten und impliziten Merkmalen beim Laufen. (A) Generalfaktor und mittlere Doppelschrittfrequenz; (B) mittlerer Bewegungsaufwand und mittlere HR; (C) Mittlerer normalisierter Shannon Entropie Index und mittlere HR.\\
	\hspace{ 
