...
\begin{figure}
	...
	\textheight]{landkarte_1} \caption[Laufstrecke -- Hin- und Rückweg]{Laufstrecke -- Hin- und Rückweg insgesamt 14~km (erstellt mit OpenStreetMap)} \label{fig:landkarte_1} 
\end{figure}
