...
Damit kann ich einen unmittelbaren Zusammenhang zwischen einer der Dimension des Flow-Erlebens und der kardio-lokomotorischen Phasensynchronisation feststellen, aber die $H^1$ (Abschnitt~\ref{sub:hypothesen}) nicht als Allgemein gültig ansehen. Aus diesem Grund testete ich im nächsten Schritt den Effekt einer \emph{physiologisch gemessenen \ac{AFP}} auf das Flow-Erleben (Abschnitt~\ref{sub:hypothesen}, $H^2$).
