...
\begin{figure}
	...
	\textheight]{landkarte_2} \caption[Gehstrecke.]{Gehstrecke -- Insgesamt 5~km (erstellt aus \acs{GPS}-Positionen mit OpenStreetMap).} \label{fig:landkarte_2} 
\end{figure}
