...
Angesichts dieser vier Forschungslücken suche und prüfe ich in den nachfolgend beschrieben Studien potentiellen Kandidaten für ein implizites Flow-Messverfahren, das eine prozessorientierte Objektivierung für den Einsatz in Apps gewährleistet. Ich beschreibe insgesamt drei Studien und deren Ergebnisse.
...
Mit der in Abschnitt~\ref{sec:flow_und_gehen_intraindividuell} beschriebenen Studie untersuche ich die Tätigkeit des Gehens intraindividuell mit dem Untersuchungsaufbau der ersten Fallstudie. Sie diente als Machbarkeitstudie des \acs{BMBF}-Projekts zur kardio-lokomotorischen Phasensynchronisation. Die kardio-lokomotorischen Phasensynchronisation wurde von mir nach der Gehstudie in die erste Laufstudie übernommen.    
