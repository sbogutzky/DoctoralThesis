...
\usepackage[backend=bibtex, pagetracker=true, bibencoding=utf8, natbib=true, style=authoryear-comp, backref=false, url=false, maxnames=3, minnames=1, uniquelist=true, isbn=false, doi=false]{biblatex} % Paket bietet erweiterte bibliographischen Einrichtungen für die Verwendung mit LaTeX in Verbindung mit BibTeX
...
\usepackage{longtable, tabu} % Mit longtable können Sie Tabellen zu schreiben, die auf der nächsten Seite weiter gehen
