...
\end{sidewaystable}
\begin{table}
	[!htb] \centering \caption[Übersicht der expliziten und impliziten Merkmale nach Messzeitpunkten (Machbarkeitsstudie: Gehen)]{Übersicht der expliziten und impliziten Merkmale nach Messzeitpunkten der Machbarkeitsstudie zum Gehen: Arithmetisches Mittel $\pm$ Standardabweichung zu den sechs Gängen [$N \approx 6$].} \label{tab:ubersicht_nach_messzeitpunkten_2} 
	\begin{tabular}
		{lyyyyy} \toprule & 15' & 30' & 45' & 60' & Gesamt \\
